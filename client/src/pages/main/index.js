...
import { getByIdProjectRequest, findAllProjectRequest } from '~/store/modules/user/actions';
...
export default function Main() {
    ...
    const { _id, lists } = useSelector(state => state.user.currentProject) || {};
    ...
    return (
        <Container>
            ...
            <div className="list-render row">{renderListFromProject(lists ? lists : [])}</div>
        </Container>
    );
}
