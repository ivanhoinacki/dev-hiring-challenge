...
module.exports = {
  ...
  bail: 1, // Aqui ele para quando encontrar um erro
  ...
  // testLocationInResults:".(js|jsx|ts|tsx)": "@sucrase/jest-plugin" false,

  // The glob patterns Jest uses to detect test files
  // aqui eu digo onde vao estar meus arquivos de teste
